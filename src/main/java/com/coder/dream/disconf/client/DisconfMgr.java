...
public class DisconfMgr {
    ...
    protected static DisconfMgr INSTANCE = null;

    public static DisconfMgr getInstance(Registry registry) {
        if(INSTANCE == null){
            INSTANCE = new DisconfMgr(registry);
            DisconfMgr.registry = registry;
        }
        return INSTANCE;
    }

    private DisconfMgr(Registry registry) {
